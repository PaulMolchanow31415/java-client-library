...
public class ValidationUtils {
    ...
    public static String getErrorMessageFromBookFields(String title, String authorName, String authorSurname, String publisherName, String publisherCity, String kind, String yearPub) {
        ...
        if (publisherName == null || publisherName.length() == 0) errorMessage.append("Не обнаружено название издательства\n");
        if (publisherCity == null || publisherCity.length() == 0) errorMessage.append("Не обнаружен город издательства\n");
